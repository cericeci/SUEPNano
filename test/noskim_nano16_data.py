...
# with command line options: --python_filename nano16.py --eventcontent NANOAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --fileout options.outputFile --conditions 106X_mcRun2_asymptotic_v17 --step NANO --filein options.inputFiles --era Run2_2016,run2_nanoAOD_106Xv2 --no_exec --mc -n -1 --customise PhysicsTools/SUEPNano/nano_suep_cff.SUEPNano_customize
