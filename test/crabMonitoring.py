...
def crabMonitoring(initProxy=False):
    ...
    cronFile.write("export SCRAM_ARCH=slc7_amd64_gcc700\n")
    ...
    cronTxt.write("00	08,20     *	*	*	"+host.split("\n")[0]+"	"+path+"/cronJob.sh\n")
    #cronTxt.write("00	00,02,04,06,08,10,12,14,16,18,22     *	*	*	lxplus.cern.ch"+"	"+path+"/cronJob.sh\n")
    cronTxt.close()
