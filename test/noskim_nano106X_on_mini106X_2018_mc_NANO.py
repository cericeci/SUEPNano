...
# with command line options: NANO -s NANO --nThreads 2 --mc --era Run2_2018 --conditions 106X_dataRun2_v28 --eventcontent NANOAODSIM --datatier NANOAOD --filein file:pippo.root -n 10 --python_filename=nano106X_on_mini106X_2018_mc_NANO.py --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('NANO nevts:10'),
