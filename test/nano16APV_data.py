...
# with command line options: --python_filename nano16apv.py --eventcontent NANOEDMAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --fileout options.outputFile --conditions 106X_mcRun2_asymptotic_preVFP_v11 --step NANO --filein options.inputFiles --era Run2_2016_HIPM,run2_nanoAOD_106Xv2 --no_exec --mc -n 100 --customise PhysicsTools/SUEPNano/nano_suep_cff.SUEPNano_customize
...
# process.nanoSequence.insert(0, process.ZS_skim)
